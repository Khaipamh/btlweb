  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="bg-white rounded-lg shadow-sm p-6 md:p-8">
        <Link to="/blog" className="text-gray-500 hover:text-blue-500 text-sm mb-4 inline-block">
          ← Quay lại
        </Link>
        <div className="flex items-center gap-2 mb-4">
          {post.Category ? (
            <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full font-medium">{post.Category.category_name}</span>
          ) : null}
