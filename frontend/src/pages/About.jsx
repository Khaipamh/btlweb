    ...
    <div className="bg-gray-50 min-h-screen py-10">
      <div className="container mx-auto px-4">
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-8">
          <div className="md:flex">
            <div className="md:w-1/2 p-8 lg:p-12 flex flex-col justify-center">
              <h1 className="text-3xl md:text-4xl font-bold text-blue-600 mb-4">Về Sahafa Bookstore</h1>
            ...
            <div className="md:w-1/2 bg-blue-100 h-64 md:h-auto relative min-h-[280px]">
              <img
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {[
            { border: 'border-blue-500', num: '1', title: 'Sách Thật 100%', text: 'Cam kết phân phối sách bản quyền từ các NXB uy tín hàng đầu Việt Nam.' },
