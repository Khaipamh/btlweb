    ...
    <div className="container mx-auto mt-6 px-4">
      <div className="bg-white rounded-lg shadow-sm overflow-hidden relative group border border-gray-100">
        <div className={`p-4 flex items-center gap-3 border-b border-gray-100 ${headerClass}`}>
          <div className={`p-1.5 rounded ${iconBgClass || 'bg-red-100 text-[#db2777]'}`}>
        ...
        <div className="relative p-2">
          <button
            type="button"
            onClick={() => scroll('left')}
            className="absolute left-0 top-1/2 -translate-y-1/2 z-20 bg-white rounded-full shadow-md w-10 h-10 flex items-center justify-center text-gray-500 hover:text-[#db2777] opacity-0 group-hover:opacity-100 transition border hidden md:flex hover:scale-110"
          >
            ‹
          </button>
                ...
                {showProgressBar ? (
                  <div className="mt-2 px-1">
                    <div className="w-full bg-pink-100 rounded-full h-4 relative overflow-hidden">
                      <div
                        className="bg-[#db2777] h-full absolute left-0 top-0"
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 z-20 bg-white rounded-full shadow-md w-10 h-10 flex items-center justify-center text-gray-500 hover:text-[#db2777] opacity-0 group-hover:opacity-100 transition border hidden md:flex hover:scale-110"
          >
            ›
          </button>
        </div>
        ...
        <div className="text-center pb-4 pt-2">
          {seeMoreLink ? (
            <Link
              to={seeMoreLink}
              className="border-2 border-[#db2777] text-[#db2777] px-12 py-2 rounded-lg font-bold text-sm hover:bg-[#db2777] hover:text-white transition duration-300 inline-block"
            >
              Xem Thêm
            </Link>
          ) : (
            <span className="border-2 border-[#db2777] text-[#db2777] px-12 py-2 rounded-lg font-bold text-sm inline-block opacity-60">
              Xem Thêm
            </span>
          )}
        </div>
